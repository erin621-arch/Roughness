...
# 入射波の設定
wn = 2.5  # 波数
wave4 = np.loadtxt(r"C:\Users\manat\project2\tmp_output\lowpassed.csv", delimiter=",")
# ==========================================
...
for omg in new_pitch_values:
    for j in new_depth_values:
        try:
            ...
            print(f"f_pitch = {f_pitch}")
            print(f"f_depth = {f_depth}")
            name = f"C:\\Users\\manat\\project2\\tmp_output\\cupy_pitch{int(f_pitch * 100000)}_depth{int(f_depth * 100000)}_expwave.csv"
