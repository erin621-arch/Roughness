...
filename = f"C:\\Users\\manat\\project2\\surface_wave_2d_2\\T1\\T1_series_middle_moremorerange_moredepth_5.npy"
filename2 = f"C:\\Users\\manat\\project2\\surface_wave_2d_2\\T3\\T3_series_middle_moremorerange_moredepth_5.npy"
data_kabe_T1 = np.load(filename)
data_yuka_T3 = np.load(filename2)
zure = (1924 + 2075) / 2 - 2000
z1 = 49
z2 = 224
x1 = 30
x2 = 40
...
plt.savefig(r"C:\Users\manat\project2\drawing\jasa2\Figure100a.png", format="eps", dpi=300)
plt.show()
...
cbar = plt.colorbar(im)
cbar.set_label("[Pa]", rotation=0, labelpad=10)
plt.savefig(r"C:\Users\manat\project2\drawing\jasa2\Figure100b.png", format="png", dpi=300)
plt.show()
...
yf200_20, freq = sourse_new.make_fftdata_main_tale(
    sourse_new.kiritori2(
        sourse_new.interpolate_sim_one(-np.loadtxt(r"C:\Users\manat\project2\data_all\cupy_pitch200_depth20.csv")[9000:]),
        sourse_new.left,
        sourse_new.right,
    ),
    sourse_new.exp_dt,
...
yf125_20, freq = sourse_new.make_fftdata_main_tale(
    sourse_new.kiritori2(
        sourse_new.interpolate_sim_one(-np.loadtxt(r"C:\Users\manat\project2\data_all\cupy_pitch125_depth20.csv")[9000:]),
        sourse_new.left,
        sourse_new.right,
    ),
    sourse_new.exp_dt,
...
yf200_20, freq = sourse_new.make_fftdata_main_tale(
    sourse_new.kiritori2(wave200_20, sourse_new.left, sourse_new.right), sourse_new.exp_dt, 1900
)
yf125_20, freq = sourse_new.make_fftdata_main_tale(
    sourse_new.kiritori2(wave125_20, sourse_new.left, sourse_new.right), sourse_new.exp_dt, 1900
)
...
yf_surface_200, freq_surface = sourse_new.make_fftdata(
    sourse_new.interpolate_sim_one(
        sourse_new.kiritori2(data2[-1, int((z3 + z4) / 2), :], sourse_new.left, sourse_new.right + 1)
    ),
    sourse_new.exp_dt,
)
