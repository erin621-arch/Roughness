...
if __name__ == "__main__":
    ...
    # target_sim_filename = "kusabi_cupy_pitch125_depth20_step1.csv"

    target_sim_filename = "hanen_cupy_pitch125_depth20.csv"
    # target_sim_filename = "hanen_cupy_pitch125_depth20_step1.csv"
    ...
    plt.figure(figsize=(8, 5))
    plt.plot(f_full, ratio_exp_full, label="Exp Ratio", color='tab:orange')
    plt.plot(f_full, ratio_sim_full, label="Sim Ratio", color='tab:blue')
    ...
    # 平滑化処理およびその出力を削除し、生データの出力のみ残しました
